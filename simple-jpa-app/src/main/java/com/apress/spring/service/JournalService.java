...
public class JournalService {
	...
	public void insertData() throws ParseException {
		...
		repo.save(new Journal("스프링 부트 클라우드", "클라우드 파운드리를 응용한 스프링 부트를 공부했다", "09/22/2017"));
		log.info("> 완료.");
	}
	...
	public List<Journal> findByTitleLike(String word) {
		return repo.findByTitleLike(word);
	}
	
	public List<Journal> searchByTitleLike(String word) {
		return repo.searchByTitleLike(word);
	}
